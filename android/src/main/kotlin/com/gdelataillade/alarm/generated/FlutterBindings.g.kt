...
private fun deepEqualsFlutterBindings(a: Any?, b: Any?): Boolean {
  ...
  if (a is Array<*> && b is Array<*>) {
    return a.size == b.size &&
        a.indices.all{ deepEqualsFlutterBindings(a[it], b[it]) }
  }
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.keys.all {
        (b as Map<Any?, Any?>).containsKey(it) &&
        deepEqualsFlutterBindings(a[it], b[it])
    }
  }
  return a == b;
}
...
data class VolumeSettingsWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    && deepEqualsFlutterBindings(fadeSteps, other.fadeSteps)
...
data class NotificationSettingsWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    && keepNotificationAfterAlarmEnds == other.keepNotificationAfterAlarmEnds
  }
